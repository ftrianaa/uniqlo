  ...
  return (
    <>
      {isDesktop ? (
        ...
        <>
          <Box bgColor="white" px={{ base: '5', md: 10 }} py="5">
            <Box>
              <Text fontWeight="bold" fontSize="15px" textTransform="uppercase">
                alamat email
              </Text>
              <Text fontSize="15px">jieunssiu@gmail.com</Text>
            </Box>
            <Box my="3">
              <Text fontWeight="bold" fontSize="15px" textTransform="uppercase">
                Nama
              </Text>
              <Text fontSize="15px">jieunssiu</Text>
            </Box>
            <Box my="3">
              <Text fontWeight="bold" fontSize="15px" textTransform="uppercase">
                alamat
            ...
            <Box my="3">
              ...
              <Text fontSize="15px">21312312</Text>
            </Box>
            <Box my="3">
              <Text fontWeight="bold" fontSize="15px" textTransform="uppercase">
                nomor ponsel
            ...
            <Box my="3">
              ...
              <Text fontSize="15px">tidak dipilih</Text>
            </Box>
          </Box>
        </>
      )}
